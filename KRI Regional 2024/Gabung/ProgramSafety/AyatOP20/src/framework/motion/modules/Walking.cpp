...
Walking::Walking()
{
    ...
    //////////////////// Posisi tangan untuk walk ready ////////////////////////////
	m_Joint.SetAngle(JointData::ID_R_SHOULDER_PITCH, -41.345);
	...
	//m_Joint.SetValue(JointData::ID_L_LEFT,1741);
	//m_Joint.SetValue(JointData::ID_R_RIGHT,2310);
