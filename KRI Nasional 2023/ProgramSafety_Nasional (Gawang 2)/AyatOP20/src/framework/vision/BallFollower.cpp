...
int mid = 104;							// Nilai tengah
int leftLimit = mid - 100;		//4	// Batas awal arah lurus
int rightLimit = mid + 100;		//204	// Batas akhir arah lurus
int Behind = mid + 180;			//284		// Batas akhir arah kanan
