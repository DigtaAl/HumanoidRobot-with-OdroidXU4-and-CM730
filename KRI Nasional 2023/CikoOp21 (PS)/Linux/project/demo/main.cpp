...
void maju()
{
	...
	Walking::GetInstance()->HIP_PITCH_OFFSET = 26.8;
...
void akselmaju()
{
	 Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 28.8;
    Walking::GetInstance()->BALANCE_ENABLE =true;
...
void akselerasimaju()
{
	...
	Walking::GetInstance()->BALANCE_ENABLE =true;
	 Walking::GetInstance()->Z_MOVE_AMPLITUDE=40;
	Walking::GetInstance()->A_MOVE_AMPLITUDE = -6.0;
	Walking::GetInstance()->X_MOVE_AMPLITUDE=39;
}
void maju1()
{
	 Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
    ...
    Walking::GetInstance()->BALANCE_ENABLE =true;
     Walking::GetInstance()->Z_MOVE_AMPLITUDE=40;
	Walking::GetInstance()->X_MOVE_AMPLITUDE=30;
}
void akselmaju2()
{
	 Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 23.8;
//Walking::GetInstance()->HIP_PITCH_OFFSET = 26.8; // line 5
    Walking::GetInstance()->BALANCE_ENABLE =true;
     Walking::GetInstance()->Z_MOVE_AMPLITUDE=40;
	Walking::GetInstance()->X_MOVE_AMPLITUDE=20;
}
...
void mundur()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 20.1;
	//Walking::GetInstance()->HIP_PITCH_OFFSET = 21.1; //line 5
	Walking::GetInstance()->BALANCE_ENABLE =true;
	 Walking::GetInstance()->Z_MOVE_AMPLITUDE=40;
...
void akselemundur()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 18.1;
	Walking::GetInstance()->BALANCE_ENABLE =true;
	 Walking::GetInstance()->Z_MOVE_AMPLITUDE=40;
	Walking::GetInstance()->A_MOVE_AMPLITUDE = 15.0;
//Walking::GetInstance()->A_MOVE_AMPLITUDE = 17.0; // line 5
	Walking::GetInstance()->X_MOVE_AMPLITUDE=-20;

}

void akselerasimundur()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 16.0;
	Walking::GetInstance()->BALANCE_ENABLE =true;
	//Walking::GetInstance()->PERIOD_TIME = 660;
	 Walking::GetInstance()->Z_MOVE_AMPLITUDE=40;
	Walking::GetInstance()->X_MOVE_AMPLITUDE=-35;
	Walking::GetInstance()->A_MOVE_AMPLITUDE = 7.0; // line,4,6,3,2
//	Walking::GetInstance()->A_MOVE_AMPLITUDE = 5.0; // line ,7
//	Walking::GetInstance()->A_MOVE_AMPLITUDE = 3.0; // line ,1
		//Walking::GetInstance()->A_MOVE_AMPLITUDE = 2.0; //line 5
}
void berhenti()
{
    Walking::GetInstance()->m_Joint.SetEnableBodyWithoutHead(true, true);
	Walking::GetInstance()->Start();
	Walking::GetInstance()->HIP_PITCH_OFFSET = 20.5;
...
int main(void)
{
    ...
    while(1)
    {
        ...
        case SPRINT:
          if(Action::GetInstance()->IsRunning() == 0 &&
                    StatusCheck::m_sprint_sub_mode == SPRINT_PLAY)
              {
